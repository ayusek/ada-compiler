...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_proced1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#92a0d24a#;
   pragma Export (C, u00001, "proced1B");
   ...
   u00083 : constant Version_32 := 16#0936cab5#;
   pragma Export (C, u00083, "system__memoryB");
   u00084 : constant Version_32 := 16#e96a4b1e#;
